...
namespace Utils
{
    public class Utility
    {
        ...
        private const string defaultDomainPath = "chemical";
        #endregion

        #region Attributes
        private static string crtDomain = "chemical.ai";
        private static string crtUserName = "Administrator";
        private static string crtPassword = "Chemical.ai";
